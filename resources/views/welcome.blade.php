    ...
    <main class="pt-20 px-6 max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-12 gap-8">
        ...
        <div class="md:col-span-6 space-y-6">
            ...
            <article class="glass-panel rounded-2xl overflow-hidden">
                ...
                <div class="p-4 flex items-center justify-between">
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="text-[10px] text-slate-400">{{ $post->created_at->diffForHumans() }} • <span class="material-symbols-outlined text-[10px] align-middle">public</span></p>
                        </div>
                    </div>
                ...
                @if($post->noi_dung)
                <div class="px-4 pb-3">
                    <p class="text-sm leading-relaxed text-on-surface-variant">{{ $post->noi_dung }}</p>
                </div>
                @endif
                ...
                <div class="grid gap-2 px-4 pb-4">
                    ...
                    <video controls class="w-full max-h-[500px] rounded-2xl bg-black">
                        <source src="{{ asset('storage/' . $media->duong_dan) }}" type="video/mp4" />
                        Trình duyệt của bạn không hỗ trợ thẻ video.
                    </video>
                    @else
                    <!-- Hiển thị ảnh -->
                    <img src="{{ asset('storage/' . $media->duong_dan) }}" alt="Post media" class="w-full rounded-2xl object-cover" />
                    @endif
                    @endforeach
                </div>
                @endif
                ...
                <div class="p-4 border-t border-white/5">
                    ...
                    <!-- Các nút tương tác -->
                    <div class="nj-reaction-bar flex items-center justify-around" data-bai-viet-id="{{ $post->id }}" data-phan-ung="">
                        <div class="nj-btn-wrap" data-bai-viet-id="{{ $post->id }}">
...
>>>>>>> cf25e82d8c64997a2663b3b8046e80c5234ace51
